package JavaOfficalSample.IssuesInThread;
...
public class MemoryConsistencyError {
    ...
    static class ThreadIncreaseCounter implements Runnable {
        ...
        @Override
        public void run() {
            System.out.println("ThreadSample : " + Thread.currentThread().getName() + " increases counter!");
    ...
    static class ThreadPrintCounter implements Runnable {
        ...
        @Override
        public void run() {
            System.out.println("ThreadSample : " + Thread.currentThread().getName() + " print counter!");
            this.counter.value();
        }
